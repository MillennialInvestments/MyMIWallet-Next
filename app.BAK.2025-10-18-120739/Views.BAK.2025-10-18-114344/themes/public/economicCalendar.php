<?php 
$economicCalendar = $economicCalendar ?? []; // Retrieve the economic calendar data
...
$nextWeekEarnings = array_filter($economicCalendar, function ($event) use ($startDate, $endDate) {
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item text-primary active" aria-current="page">Economic Calendar</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="intro-section bg-light">
    <div class="container">
        <div class="section-title">
            ...
            <p>Track market-moving events, including earnings, dividends, and economic indicators.</p>
        </div>
    </div>
</div>
...
<div class="container py-5">
            ...
            <?php if (!empty($symbols)) : ?>
                <div class="d-flex flex-wrap justify-content-center">
                    <?php foreach ($symbols as $symbol) : ?>
                        <?php $logoPath = "/assets/logos/{$symbol}.png"; ?>
    ...
    <div class="row mb-5">
        <div class="col-12 table-container">
            <h2>Full Economic Calendar</h2>
            <?php if (!empty($economicCalendar)) : ?>
                <table id="economic-calendar-table" class="table table-striped table-hover">
                    <thead>
                        <tr>
                            <th>Date</th>
                            <th>Time</th>
