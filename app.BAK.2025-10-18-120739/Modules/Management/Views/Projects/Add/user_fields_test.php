...
<div class="form-group">
    ...
    <input type="text" id="name" name="name" class="<?= $formControl; ?>" placeholder="Enter project name" value="Test Project" required>
</div>

<div class="form-group">
    <label for="description">Description</label>
    <textarea id="description" name="description" class="<?= $formControl; ?>" placeholder="Provide a brief project description" value="Test Description to ensure this makes it to the email appropriately!"></textarea>
</div>

<div class="form-group">
    <label for="target_amount">Target Amount ($)</label>
    <input type="number" id="target_amount" name="target_amount" class="<?= $formControl; ?>" step="0.01" placeholder="Enter target amount" value="100000000" required>
</div>

<div class="form-group">
    <label for="minimum_investment">Minimum Investment ($)</label>
    <input type="number" id="minimum_investment" name="minimum_investment" class="<?= $formControl; ?>" step="0.01" placeholder="Enter minimum investment amount" value="100" required>
</div>

<div class="form-group">
    <label for="maximum_investment">Maximum Investment ($)</label>
    <input type="number" id="maximum_investment" name="maximum_investment" class="<?= $formControl; ?>" step="0.01" placeholder="Enter maximum investment amount" value="1000">
</div>
...
<div class="form-group">
    ...
    <textarea id="remarks" name="remarks" class="<?= $formControl; ?>" placeholder="Any additional remarks about the project" value="This is a test remark/requirement to ensure the owner is able to list requirements to invest!"></textarea>
</div>

<div class="form-group">
    <label for="promotional_links">Additional Links:</label>
    <textarea id="promotional_links" name="promotional_links" class="<?= $formControl; ?>" placeholder="Any additional promotional_links about the project" value="https://www.mymiwallet.com, https://www.timothyburks.com"></textarea>
</div>
<hr>
