                ...
                <div class="row justify-content-center intro-feature-list">
                    <div class="col-lg-12">
                        ...
                        <div class="intro-feature-media" class="w-100 h-auto">
                            <img class="img-responsive" src="<?php echo base_url('assets/images/Earnings/' . $earningsDate . '/Earnings.jpg'); ?>" alt="Corporate Earnings Calendar <?= $earningsDate; ?>" class="object-fit-contain">
                        </div>
                    </div>
                </div>
            </div>
