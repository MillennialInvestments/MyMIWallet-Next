...
<div class="nk-block">
    <div class="row">
        <div class="col-md-12 col-xl-3 my-sm-3">
            <h1>Create Solana Wallet - MyMI Wallet</h1>
            <p>Use the form below to generate a new Solana wallet and attach it to your MyMI Wallet account.</p>
            ...
            <form action="<?= base_url('Exchange/SolanaController/createWallet') ?>" method="post">
