...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const cleanData = budgetData.filter(isValidRecord);
    console.log('Validated Budget Data:', cleanData);
        ...
        data: {
            ...
            datasets: [
                ...
                { type: 'bar', label: 'Expenses', data: [], backgroundColor: '#e85347', borderWidth: 1 },
                {
                    ...
                    borderWidth: 3, // Primary line thickness
                    pointBackgroundColor: [], // Point colors
                    pointBorderColor: '#000', // Outline for points
                    pointBorderWidth: 2, // Outline width
    ...
    const updateChartData = () => {
        ...
        console.log('Cumulative Surplus:', cumulativeSurplus);

        chart.data.labels = getMonthLabels(startDate, endDate, true);
        chart.data.datasets[0].data = surpluses; // Overall
        chart.data.datasets[1].data = incomes;
        chart.data.datasets[2].data = expenses;
        chart.data.datasets[3].data = cumulativeSurplus; // Cumulative surplus
        chart.data.datasets[3].borderColor = surplusColors; // Dynamic line colors
        chart.data.datasets[3].pointBackgroundColor = surplusColors; // Dynamic point colors
        chart.update();
    };
