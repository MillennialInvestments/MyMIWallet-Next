		...
		<div class="nk-wgw">
			...
			<div class="nk-wgw-actions">
				<ul>
					...
					<li class="' . $btnSizing . '">
						<a class="depositFundsBtn" href="#" data-bs-toggle="modal" data-bs-target="#transactionModal"><i class="icon ni ni-plus"></i> <span>Deposit</span></a>
					</li>
					<li class="' . $btnSizing . '">
						<a class="withdrawFundsBtn" href="#" data-bs-toggle="modal" data-bs-target="#transactionModal"><em class="icon ni ni-minus"></em><span>Withdraw</span></a>
					</li>
				</ul>
			</div>
			<div class="nk-wgw-more dropdown">
				<a href="#" class="btn btn-icon btn-trigger" data-bs-toggle="dropdown"><i class="icon ni ni-options"></i></a>
