        ...
        <div class="nk-wgw">
            <div class="nk-wgw-inner">
                <a class="nk-wgw-name" href="' . site_url('Wallets/Credit/Details/' . $accountID) . '">
                    ...
                    if (!empty($accountStatus)) {
                        if ($accountStatus === 2) {
                            echo '<h5 class="nk-wgw-title title">' . $accountBankName . ' - ' . $accountName . ' <small>(Closed)</small></h5>';
                        } else {
                            echo '<h5 class="nk-wgw-title title">' . $accountBankName . ' - ' . $accountName . '</h5>';
                        }
                    } else {
                        echo '<h5 class="nk-wgw-title title">' . $accountBankName . ' - ' . $accountName . '</h5>';
                    }
            ...
            <div class="nk-wgw-actions">
                <ul class="vertical-divider">
                    <li class="' . $btnSizing . '">
                        <a href="' . site_url('Wallets/Credit/Details/' . $accountID) . '">
                            <i class="icon ni ni-list-index mr-1"></i> <span>Details</span>
                        </a>
                    </li>
                    <li class="' . $btnSizing . '">
                        <button class="btn dynamicModalLoader" data-formtype="Edit" data-endpoint="' . $btnID . '" data-accountid="' . $accountID . '">
            ...
            <div class="nk-wgw-more dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-xs dropdown-menu-right">
                    <ul class="link-list-plain sm">
                        <li>
                            <a href="' . site_url('Wallets/Credit/Details/' . $accountID) . '">Details</a>
                        </li>   
                        <li>
                            <a href="#" class="dynamicModalLoader" data-formtype="Edit" data-endpoint="' . $btnID . '" data-accountid="' . $accountID . '">Edit</a>
                        </li>
                        <li>
                            <a href="#" class="delete-wallet-button" 
                               data-id="' . $accountID . '" 
