...
<div class="form-group">
    ...
    <input type="number" id="investment_amount" name="investment_amount" class="<?= $formControl; ?>" step="0.01" placeholder="Enter investment amount" required>
</div>

<div class="form-group">
    <label for="investment_date">Investment Date</label>
    <input type="date" id="investment_date" name="investment_date" class="<?= $formControl; ?>" required>
</div>

<div class="form-group">
    <label for="remarks">Remarks</label>
    <textarea id="remarks" name="remarks" class="<?= $formControl; ?>" placeholder="Any additional remarks about the investment"></textarea>
</div>
