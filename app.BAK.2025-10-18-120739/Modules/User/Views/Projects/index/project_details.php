<?php
// log_message('debug', 'Projects\index\project_details L4 - $project Array: ' . (print_r($project, true))); 
?>
    ...
    <div class="card-body">
        ...
        <table class="table table-striped">
            <tbody>
                ...
                <tr><th>Project Name</th><td><strong><?= esc($project['name']); ?></strong></td></tr>
                <tr><th>Description</th><td><?= nl2br(esc($project['description'])); ?></td></tr>
                <tr><th>Stage</th><td><?= ucfirst($project['project_stage']); ?></td></tr>
                <tr><th>Submitted By</th><td><strong><?= esc($owner['cuUsername']); ?></strong></td></tr>
        ...
        <hr class="w-80">
        <!-- Actions Section -->
        <h6 class="mt-4 mb-3">Actions</h6>
        <div class="d-flex align-items-center">
            <a href="<?= site_url('User/Projects/Invest/' . $project['id']); ?>" class="btn btn-success me-2">Invest</a>
            <a href="<?= site_url('User/Projects/Sell/' . $project['id']); ?>" class="btn btn-danger me-2">Sell</a>
            <a href="<?= site_url('User/Projects/Discuss/' . $project['id']); ?>" class="btn btn-primary">Join Discussion</a>
        </div>
    </div>
</div>
