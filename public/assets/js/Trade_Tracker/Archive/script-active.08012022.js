...
class Table {
    ...
    hideTable() {
        if (!!this.target) {
            ...
            this.target.classList.add("hideThis");
            // this.target.setAttribute("style", "display: none !important");
        }
    }
    /**
        ...
        if (this.origin[gin("29")] != "-1") {
            ...
            if (this.state.isLegend) {
                ...
                if (this.state.container != "") {
                    ...
                    this.state.container.classList.remove("pl-3"); 
                }
            }
            else {
                mainRow.agd("mainRow");
...
if (mainEditPrefsWindow != null) {
    mainEditPrefsWindow.classList.add("hideThis");
    const editPrefsObj = {
