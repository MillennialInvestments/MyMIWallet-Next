 ...
 */
$routes->setAutoRoute(true); // Only this line
// $routes->setAutoRoute('improved'); // Enables auto-routing (for debugging)
// $routes->set404Override('Errors::show404');
// $routes->set404Override(function () {
//     return $this->renderTheme('errors/custom_404');
// });
$routes->setDefaultController('Home');
$routes->setDefaultMethod('index');

$routes->get('clean-url-test', function () {
    echo "Clean URLs are working!";
});
...
$routes->group('API', ['namespace' => 'App\Modules\APIs\Controllers'],  function($routes) {
    ...
    $routes->group('Management', function($routes) {
        ...
        // Marketing evergreen endpoints
        $routes->get('generateQueueForToday', 'ManagementController::generateQueueForToday');
        $routes->get('publishQueueBatch', 'ManagementController::publishQueueBatch');
        $routes->post('discordWebhook', 'ManagementController::discordWebhook');
        $routes->get('analyticsCron', 'ManagementController::analyticsCron');
    ...
    $routes->group('Wallets', function($routes) {
        ...
        $routes->get('Plaid/Link-Token', 'App\Modules\APIs\Controllers\WalletsController::plaidLinkToken');
        $routes->post('Plaid/Exchange', 'App\Modules\APIs\Controllers\WalletsController::plaidExchange');
...
$routes->group('Budget', ['namespace' => 'App\Modules\User\Controllers', 'filter' => 'login'], function($routes) {
    $routes->match(['GET', 'POST'], '/', 'BudgetController::index');
