...
class Auth extends \Myth\Auth\Config\Auth
{
     ...
     * @var string[]
     */
    public $personalFields = ['first_name', 'middle_name', 'last_name', 'name_suffix', 'ssn', 'dob', 'address', 'city', 'state', 'country', 'zipcode'];
    ...
    public $passwordValidators = [
        'App\Authentication\Passwords\CustomCompositionValidator',
