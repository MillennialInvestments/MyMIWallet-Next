...
class RmSession extends BaseOllamaCommand
{
    protected $name = 'ollama:sessions:rm';
    protected $description = 'Deletes a session record.';
    ...
    public function run(array $params)
    {
        ...
        return $this->emitPayload([
            'status' => 'warning',
            'message' => 'ollama:sessions:rm is scaffolded and ready for extension.',
