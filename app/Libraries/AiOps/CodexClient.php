...
class CodexClient
{
    ...
    /**
     * Wrap Codex API calls with caps, caching, and usage logging.
     *
     * @param string   $subsystem codex_codegen|codex_docs_alignment
    ...
    protected function getTtlSeconds(string $subsystem): int
    {
        return match ($subsystem) {
            'codex_docs_alignment' => 60 * 15, // 15m optional cache
            default                => 0,
        };
    }
