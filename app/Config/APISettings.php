...

{
    ...
    public string $mediastackReferralLink = "https://mediastack.com?ref=your_referral_code"; // Replace with actual referral code


    // MarketAux settings
    public string $marketAuxApiKey = 'RzfJIiKUfYcb7MH4jNcowbcLU54Nu0Qjc0HF5wLY';
    public string $marketAuxApiUrl = 'https://api.marketaux.com/v1/news/all';
    public string $marketAuxApiDocs = 'https://www.marketaux.com/documentation';
