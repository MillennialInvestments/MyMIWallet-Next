...
$totalActiveUsers       = $reportingData['totalActiveUsers'] ?? 0;
$totalWalletsCreated    = $reportingData['totalWalletsCreated'] ?? 0;
$totalTradesTracked     = $reportingData['totalTradesTracked'] ?? 0;
$totalActivePartners    = $reportingData['totalActivePartners'] ?? 0;
$totalApprovedAssets    = $reportingData['totalApprovedAssets'] ?? 0;
$formData               = array(
    'title'             => $title,
                    ...
                    <div class="intro-banner-inner text-center">
                        <div class="intro-banner-desc py-md-2 py-lg-5">
                            <div class="row">
                                ...
                                <h1 class="title text-white" class="fs-1">MyMI Wallet<br>Financial Education Management Blog and More!</h1>
                                <h2 class="subttitle text-white pb-3" class="fs-4">Master Your Finances:<br>Personal Finance &amp; Investment Literacy</h2>
