...
class IRSController extends UserController
{
    use ResponseTrait;
    protected $auth;
...
//         $this->MyMIUser                                 = new MyMIUser(); // replaced by BaseController getter
    ...
    public function index()
    {
        ...
        $this->renderTheme('App\Modules\Blog\Views\IRS\index', $this->data);
    }

    public function IRSExpandedHomeEnergyTaxCredits()
    {
        $this->data['pageTitle']                        = 'The Fundamentals of Investing 101 | MyMI Wallet';
        $this->commonData(); // Ensure this is correctly populating $this->data
        $this->renderTheme('App\Modules\Blog\Views\IRS\IRS_Expanded_Home_Energy_Tax_Credits', $this->data);
    }
