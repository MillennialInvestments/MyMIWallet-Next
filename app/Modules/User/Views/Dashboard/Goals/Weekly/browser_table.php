                    ...
                    <div class="card-title-group align-start mb-3">
                        ...
                        <div class="card-tools mt-3 mt-md-0 d-flex flex-column flex-md-row justify-content-md-end w-100">
                            ...
                            <div class="d-flex flex-wrap justify-content-center justify-content-md-end">
                                <a class="btn btn-success btn-sm text-white me-2 mb-2" href="https://www.mymiwallet.com/Budget/Add/Income"><i class="icon ni ni-plus"></i> Income</a>
                                <a class="btn btn-danger btn-sm text-white me-2 mb-2" href="https://www.mymiwallet.com/Budget/Add/Expense"><i class="icon ni ni-plus"></i> Expense</a>
                                ...
                                <a class="btn btn-outline-secondary btn-sm me-2 mb-2" href="https://www.mymiwallet.com/Budget/History"><i class="icon ni ni-history"></i> History</a>
