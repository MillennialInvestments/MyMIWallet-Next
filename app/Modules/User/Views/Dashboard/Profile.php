...
<div class="nk-block investment-overview">
    ...
    <div class="row g-gs">
        ...
        <!-- <div class="col-12 col-md-4">
            <?php //echo view('UserModule\Views\Dashboard\Profile\investor_strength_score', $subViewData); ?>
        </div> -->
        <!-- Project Participation -->
        <div class="col-12 col-md-12">            
            <div class="card card-bordered">
                <?php echo view('UserModule\Views\Dashboard\Profile\user_mymi_projects', $subViewData); ?>
            </div>
        </div>
    </div>
</div>
