...
log_message('debug' , 'Budget\index L233 - $creditAvailable: ' . $creditAvailable);
}
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function changeData(lower, upper, chart){
        lower.day = 1;
        upper.day = 31;
        chart.data.datasets[0].data = overall(expensesOrIncomes("Expense", data, lower, upper), expensesOrIncomes("Income", data, lower, upper));
        chart.data.datasets[1].data = expensesOrIncomes("Income", data, lower, upper);
        chart.data.datasets[2].data = expensesOrIncomes("Expense", data, lower, upper);
