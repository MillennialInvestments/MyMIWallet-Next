    ...
    <div class="card-inner-group">
        ...
        <div class="card-inner">
            <div class="nk-wg-action">
                <div class="nk-wg-action-content">
                    ...
                    <div class="title"><strong>MyMI Gold Daily Goals:</strong></div>
                    <p>
                        Receives Rewards for completing your <a href="<?php echo site_url('MyMI-Gold/Goals/Daily'); ?>">Daily Goals for MyMIGold</a>! 
                    </p>
                </div>
                <a href="<?php echo site_url('MyMI-Gold/Goals/Daily'); ?>" class="btn btn-icon btn-trigger me-n2"><em class="icon ni ni-forward-ios"></em></a>
        ...
        <div class="card-inner">
            <div class="nk-wg-action">
                <div class="nk-wg-action-content">
                    <em class="icon ni ni-activity"></em>
                    <div class="title"><strong>Investments:</strong> <?= $investSummaryFMT; ?></div>
                    <p>
                        Manage your 
                        Investments
        ...
        <div class="card-inner">
            <div class="nk-wg-action">
                <div class="nk-wg-action-content">
                    <em class="icon ni ni-wallet-out"></em>
                    <div class="title">Activate Your Membership For More!</div>
                    <p>
                        Manage your 
                        <a href="<?= site_url('/Memberships/Customize') ?>">Account Membership &amp; Services</a> 
                        <!-- 
                            // #NEXTSTEPS Change to this once Individual Wallet Overviews are completed (/Wallets/Checking, /Wallets/Savings, etc.)
                            <a href="<?php //echo site_url('/Wallets/Checking'); ?>">Checking Accounts</a>  
                        -->
                        to access more Premium Tools at MyMI Wallet.
                    </p>
                </div>
                <!-- <a href="#budgeting-monthly-financial-overview" class="btn btn-icon btn-trigger me-n2"><em class="icon ni ni-forward-ios"></em></a> -->
            </div>
