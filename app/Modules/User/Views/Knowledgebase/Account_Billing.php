    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="content">
                ...
                <?php echo view('UserModule\Views\Knowledgebase\includes\Partnerships\subheader', $subViewData); ?>
                <?php echo view('UserModule\Views\Knowledgebase\includes\Partnerships\full_content', $subViewData); ?>
                <?php echo view('UserModule\Views\Knowledgebase\includes\Partnerships\more_details', $subViewData); ?>
                ...
                <?php echo view('UserModule\Views\Knowledgebase\includes\KYC_Verification\getting_started', $subViewData); ?>
                <?php echo view('UserModule\Views\Knowledgebase\includes\KYC_Verification\more_details', $subViewData); ?>
                ...
                <?php echo view('UserModule\Views\Knowledgebase\includes\Referral_Program\getting_started', $subViewData); ?>
                <?php echo view('UserModule\Views\Knowledgebase\includes\Referral_Program\more_details', $subViewData); ?>
                ...
                <?php //echo view('UserModule\Views\Knowledgebase\includes\Customer_Support\header', $subViewData); ?>
                <?php //echo view('UserModule\Views\Knowledgebase\includes\Customer_Support\contact_support', $subViewData); ?>
            </div>
        </div>
    </div>
</div>
