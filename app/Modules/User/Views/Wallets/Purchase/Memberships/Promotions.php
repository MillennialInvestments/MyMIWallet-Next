                        ...
                        <div class="card card-bordered pricing text-center">
                            <div class="pricing-body">
                                ...
                                <div class="pricing-amount">
                                    <div class="bill text-muted"><strong><small>Was $<?= $membershipStarterFee; ?> <span>/ Mth</span></small></strong></div>
                                    <div class="amount">$<?= $membershipStarterFeePromo; ?> <span>/ Mth</span></div>
                    ...
                    <div class="col-md-6 col-xxl-3">
                        <div class="card card-bordered pricing recommend text-center">
                            ...
                            <div class="pricing-body">
                                ...
                                <div class="pricing-amount">
                                    <div class="bill text-muted"><strong><small>Was $<?= $membershipBasicFee; ?> <span>/ Mth</span></small></strong></div>
                                    <div class="amount">$<?= $membershipBasicFeePromo; ?> <span>/ Mth</span></div>
                                    <span class="bill">Billed Monthly</span>
                                </div>
                                <ul class="d-block d-md-none pricing-features">
                                    <li><span class="w-80">Personal Budgeting Tool</span> <span>Free</span></li>
                    ...
                    <div class="col-md-6 col-xxl-3">
                        <div class="card card-bordered pricing text-center">
                            <div class="pricing-body">
                                ...
                                <div class="pricing-amount">
                                    <div class="bill text-muted"><strong><small>Was $<?= $membershipProFee; ?> <span>/ Mth</span></small></strong></div>
                                    <div class="amount">$<?= $membershipProFeePromo; ?> <span>/ Mth</span></div>
                                    <span class="bill">Billed Monthly</span>
                                </div>
                                <ul class="d-block d-md-none pricing-features">
                                    <li><span class="w-80">Personal Budgeting Tool</span> <span>Free</span></li>
                    ...
                    <div class="col-md-6 col-xxl-3">
                        <div class="card card-bordered pricing text-center">
                            <div class="pricing-body">
                                ...
                                <div class="pricing-amount">
                                    <div class="bill text-muted"><strong><small>Was $<?= $membershipPremiumFee; ?> <span>/ Mth</span></small></strong></div>
                                    <div class="amount">$<?= $membershipPremiumFeePromo; ?> <span>/ Mth</span></div>
                                    <span class="bill">Billed Monthly</span>
                                </div>
                                <ul class="d-block d-md-none pricing-features">
                                    <li><span class="w-80">Personal Budgeting Tool</span> <span>Free</span></li>
