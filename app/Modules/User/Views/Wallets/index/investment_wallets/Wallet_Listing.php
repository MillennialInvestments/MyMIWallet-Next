...
$deleteName     = (string) ($accountName ?? $accountBroker ?? 'Investment Wallet');
    ...
    <div class="card card-bordered">
        <div class="nk-wgw">
            <div class="nk-wgw-inner">
                <a class="nk-wgw-name" href="' . site_url('Wallets/Investment/Details/' . $childAccountId) . '">
                    <div class="nk-wgw-icon is-default"><i class="icon ni ni-wallet"></i></div>
                    <h5 class="nk-wgw-title title">' . esc($accountBroker ?? '') . ' - ' . esc($accountName ?? '') . '</h5>
                </a>
            ...
            <div class="nk-wgw-actions">
                <ul class="vertical-divider">
                    <li class="' . esc($btnSizing ?? '') . '">
                        <a href="' . site_url('Wallets/Investment/Details/' . $childAccountId) . '">
                    ...
                    <li class="' . esc($btnSizing ?? '') . '">
                        <button class="btn dynamicModalLoader"
                                data-formtype="Edit"
                                data-endpoint="' . esc($btnID ?? 'editInvestAccount') . '"
            ...
            <div class="nk-wgw-more dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-xs dropdown-menu-right">
                    <ul class="link-list-plain sm">
                        <li>
                            <a href="' . site_url('Wallets/Investment/Details/' . $childAccountId) . '">Details</a>
                        </li>
                        <li>
                            <a href="#"
