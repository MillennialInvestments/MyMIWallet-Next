		...
		<div class="nk-wgw">
			...
			<div class="nk-wgw-actions">
                <ul class="vertical-divider">   
					<li class="' . $btnSizing . '">
						<a href="' . site_url('Wallets/Investment/Details/' . $accountID) . '">
			...
			<div class="nk-wgw-more dropdown">
				...
				<div class="dropdown-menu dropdown-menu-xs dropdown-menu-right">
					<ul class="link-list-plain sm">
						<li>
                            <a href="' . site_url('Wallets/Investment/Details/' . $accountID) . '">Details</a>
                        </li>   
						<li>
                            <a href="' . site_url('/Wallets/Investment/Edit/Account/' . $accountID) . '">Edit</a>
                        </li>
                        <li>
                            <a href="#" class="delete-wallet-button" 
                               data-id="' . $accountID . '" 
