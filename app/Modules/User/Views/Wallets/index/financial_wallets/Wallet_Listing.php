...
$deleteName     = (string) ($accountName ?? $accountBankName ?? 'Bank Wallet');
    ...
    <div class="card card-bordered">
        <div class="nk-wgw">
            <div class="nk-wgw-inner">
                <a class="nk-wgw-name" href="' . site_url('Wallets/Banking/Details/' . $childAccountId) . '">
            ...
            <div class="nk-wgw-actions">
                <ul class="vertical-divider">
                    <li class="' . esc($btnSizing ?? '') . '">
                        <a href="' . site_url('Wallets/Banking/Details/' . $childAccountId) . '">
            ...
            <div class="nk-wgw-more dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-xs dropdown-menu-right">
                    <ul class="link-list-plain sm">
                        <li><a href="' . site_url('Wallets/Banking/Details/' . $childAccountId) . '">Details</a></li>
                        <li>
                            <a href="#"
