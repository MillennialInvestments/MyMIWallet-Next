...
<?php
    ...
    echo view('UserModule\Views\Wallets\index\investment_wallets\MyMIWallet', $MyMIWalletData);
    if (!empty($getUserInvestAccounts)) {
        foreach ($getUserInvestAccounts as $accountInfo) {
            ...
            echo view('UserModule\Views\Wallets\index\investment_wallets\Wallet_Listing', $walletData);
        }
    }
