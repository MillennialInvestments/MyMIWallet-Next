    ...
    <div class="col-md-12 col-xl-9">
      ...
      <div class="card card-bordered mb-3">
        <div class="card-inner">
          ...
          <?php echo view('UserModule\Views\Projects\holdings\analytics_chart', $subViewData); ?>
        </div>
      </div>
            ...
            <div class="col-md-4">
              <div class="card card-bordered h-100">
                <div class="card-inner">
                  ...
                  <?php echo view('UserModule\Views\Projects\holdings\list_commitments', $subViewData); ?>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card card-bordered h-100">
                <div class="card-inner">
                  ...
                  <?php echo view('UserModule\Views\Projects\holdings\list_investments', $subViewData); ?>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card card-bordered h-100">
                <div class="card-inner">
                  ...
                  <?php echo view('UserModule\Views\Projects\holdings\list_distributions', $subViewData); ?>
                </div>
              </div>
            </div>
          </div>
