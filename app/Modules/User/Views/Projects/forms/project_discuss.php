    ...
    <div class="modal-body">
        <form class="form-horizontal" id="discuss_project_form" method="POST">
            ...
            <div class="nk-block">
                ...
                <hr>
                <fieldset>
                    <?php echo view('UserModule\Views\Projects\forms\fields\discuss_fields', $fieldData); ?>
                </fieldset>
                <fieldset>
                        ...
                        <div class="card px-2 pb-4">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" id="discuss_project_form" method="POST">
                                    ...
                                    <div id="form-errors" class="alert alert-danger d-none"></div>
                                    <fieldset>
                                        <?php echo view('UserModule\Views\Projects\forms\fields\discuss_fields', $subViewData); ?>
                                    </fieldset>
                                    <fieldset>
