...
<div class="form-group">
    ...
    <input type="number" id="commitment_amount" name="commitment_amount" class="<?= $formControl; ?>" step="0.01" placeholder="Enter commitment amount" required>
</div>

<div class="form-group">
    <label for="remarks">Remarks</label>
    <textarea id="remarks" name="remarks" class="<?= $formControl; ?>" placeholder="Any additional remarks about the commitment"></textarea>
</div>
