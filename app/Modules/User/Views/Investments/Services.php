...
<script <?= $nonce['script'] ?? '' ?>>
    ...
    'getBatchStockQuotes': 'GlOBAL_QUOTE', // updated endpoint
    'getCashFlow': 'CASH_FLOW',
    'getEarnings': 'EARNINGS',
    'getIncomeStatement': 'INCOME_STATEMENT',
    'getIntraday': 'TIME_SERIES_INTRADAY',
    'getIntradayExtended': 'TIME_SERIES_INTRADAY_EXTENDED', // custom endpoint
    'getMonthly': 'TIME_SERIES_MONTHLY',
    'getMonthlyAdjusted': 'TIME_SERIES_MONTHLY_ADJUSTED',
    'getOverview': 'OVERVIEW',
    'getPrice': 'GLOBAL_QUOTE', // assuming global quote for price
    'getQuoteEndpoint': 'GLOBAL_QUOTE',
    'getSearchEndpoint': 'SYMBOL_SEARCH',
    'getSector': 'SECTOR',
    'getSplits': 'TIME_SERIES_DAILY_ADJUSTED', // assuming daily adjusted for splits
    'getTimeSeriesDaily': 'TIME_SERIES_DAILY',
    'getTimeSeriesDailyAdjusted': 'TIME_SERIES_DAILY_ADJUSTED',
    ...
    'getCryptoOverview': 'CRYPTO_OVERVIEW', // custom endpoint
