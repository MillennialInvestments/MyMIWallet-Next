...
$budgeting_complete                   = $userAssessment['budgeting_complete']; 
if ($budgeting_complete === 'Yes') {
    $budgeting_completeStatus       = 'Completed'; 
} elseif ($budgeting_complete === 'No') {
    $budgeting_completeStatus       = 'Pending'; 
}
...
$personal_budgeting                   = $userAssessment['personal_budgeting']; 
if ($personal_budgeting === 'Yes') {
    $personal_budgetingStatus       = 'Completed'; 
} elseif ($personal_budgeting === 'No') {
    $personal_budgetingStatus       = 'Pending'; 
}
$portfolio_manager                   = $userAssessment['portfolio_manager']; 
if ($portfolio_manager === 'Yes') {
    $portfolio_managerStatus       = 'Completed'; 
} elseif ($portfolio_manager === 'No') {
    $portfolio_managerStatus       = 'Pending'; 
}
$automated_integration                   = $userAssessment['automated_integration']; 
if ($automated_integration === 'Yes') {
    $automated_integrationStatus       = 'Completed'; 
} elseif ($automated_integration === 'No') {
    $automated_integrationStatus       = 'Pending'; 
}
$asset_creator                   = $userAssessment['asset_creator']; 
if ($asset_creator === 'Yes') {
    $asset_creatorStatus       = 'Completed'; 
} elseif ($asset_creator === 'No') {
    $asset_creatorStatus       = 'Pending'; 
}
// echo $cuRole; 
// Time Configurations
$current_year                       = date('Y');
...
$allViewData                        = array(
    ...
    'budgeting_complete'            => $budgeting_complete,
    'budgeting_completeStatus'      => $budgeting_completeStatus,
    ...
    'personal_budgeting'            => $personal_budgeting,
