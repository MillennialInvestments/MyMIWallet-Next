...
use App\Models\{AccountsModel, AnnouncementsModel, BudgetModel, DesignModel, InvestmentModel, MarketingModel, MyMIGoldModel, UserModel, WalletModel};
use Config\Services;
...
class SupportAdminController extends UserController
{
    use ResponseTrait;
    use RequestTrait;
...
//         $this->MyMIWallets = new MyMIWallets(); // replaced by BaseController getter
    ...
    {
        $this->data['pageTitle'] = 'Support | Management | MyMI Wallet';
        $this->commonData();
        return $this->renderTheme('App\Modules\Management\Views\Support\index', $this->data);
    }

    public function logs()
    {
        $errorLogs = $this->logViewer->showLogs();
        $this->data['pageTitle'] = 'Management Support Logs';
        $this->commonData();
        $this->data['errorLogs'] = $errorLogs;
        return $this->renderTheme('App\Modules\Management\Views\Support\logs', $this->data);
    }

    public function requests()
    {
        $this->data['pageTitle'] = 'Support Requests | Management | MyMI Wallet';
        $this->commonData();
        return $this->renderTheme('App\Modules\Management\Views\Support\requests', $this->data);
    }

    public function reporting()
    {
        $this->data['pageTitle'] = 'Support Reporting | Management | MyMI Wallet';
        $this->commonData();
        return $this->renderTheme('App\Modules\Management\Views\Support\reporting', $this->data);
    }

    public function contentCreator()
    {
        $this->data['pageTitle'] = 'Content Creator | Management | MyMI Wallet';
        $this->commonData();
        return $this->renderTheme('App\Modules\Management\Views\Support\content_creator', $this->data);
    }

    public function curlGenerator()
    {
        $this->data['pageTitle'] = 'Curl Generator | Management | MyMI Wallet';
        $this->commonData();
        return $this->renderTheme('App\Modules\Management\Views\Support\curl_generator', $this->data);
    }

    public function pages()
    {
        $this->data['pageTitle'] = 'Web Design Pages | Management | MyMI Wallet';
        $this->commonData();
        return $this->renderTheme('App\Modules\Management\Views\Support\pages', $this->data);
    }

    public function pageTemplate()
    {
        $this->data['pageTitle'] = 'Page Template | Management | MyMI Wallet';
        $this->commonData();
        return $this->renderTheme('App\Modules\Management\Views\Support\page_template', $this->data);
    }

    public function testPage()
    {
        $this->data['pageTitle'] = 'Test Page | Management | MyMI Wallet';
        $this->commonData();
        $this->auth->restrict();
        return $this->renderTheme('App\Modules\Management\Views\Support\test_page', $this->data);
    }

    public function testPageEmail()
    {
        $this->data['pageTitle'] = 'Test Page Email | Management | MyMI Wallet';
        $this->commonData();
        return $this->renderTheme('App\Modules\Management\Views\Support\test_page_email', $this->data);
    }

    public function testPageCB()
    {
        $this->data['pageTitle'] = 'Test Page CB | Management | MyMI Wallet';
        $this->commonData();
        return $this->renderTheme('App\Modules\Management\Views\Support\test_page_cb', $this->data);
    }

    public function sitemapGenerator()
    {
        $this->data['pageTitle'] = 'Sitemap Generator | Management | MyMI Wallet';
        $this->commonData();
        return $this->renderTheme('App\Modules\Management\Views\Support\sitemap_generator', $this->data);
    }

    public function basicUI()
    {
        $this->data['pageTitle'] = 'Basic UI | Management | MyMI Wallet';
        $this->commonData();
        return $this->renderTheme('App\Modules\Management\Views\Support\basic_ui', $this->data);
    }

    public function icons()
    {
        $this->data['pageTitle'] = 'Icons | Management | MyMI Wallet';
        $this->commonData();
        return $this->renderTheme('App\Modules\Management\Views\Support\icons', $this->data);
    }

    public function forms()
    {
        $this->data['pageTitle'] = 'Forms | Management | MyMI Wallet';
        $this->commonData();
        return $this->renderTheme('App\Modules\Management\Views\Support\forms', $this->data);
    }

    public function charts()
    {
        $this->data['pageTitle'] = 'Charts | Management | MyMI Wallet';
        $this->commonData();
        return $this->renderTheme('App\Modules\Management\Views\Support\charts', $this->data);
    }

    public function tables()
    {
        $this->data['pageTitle'] = 'Tables | Management | MyMI Wallet';
        $this->commonData();
        return $this->renderTheme('App\Modules\Management\Views\Support\tables', $this->data);
    }

    public function uiElements()
    {
        $this->data['pageTitle'] = 'UI Elements | Management | MyMI Wallet';
        $this->commonData();
        return $this->renderTheme('App\Modules\Management\Views\Support\ui_elements', $this->data);
    }
