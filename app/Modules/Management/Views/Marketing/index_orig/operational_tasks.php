        ...
        <div class="card-inner">
            <div class="project">
                <div class="project-head">
                    <a href="<?php echo site_url('Management/Marketing/Analytics'); ?>" class="project-title">
                        <div class="user-avatar sq bg-purple"><span>MA</span></div>
                        <div class="project-info">
                            <h6 class="title"><?php echo $department; ?> Analytics</h6>
                ...
                <div class="project-details">
                    <p>View Marketing Analytics and More!.</p>
                </div>
...
<div class="col-sm-6 col-xl-4">
    <div class="card card-bordered h-100">
        <div class="card-inner">
            <div class="project">
                <div class="project-head">
                    <a href="<?php echo site_url('Management/Marketing/Campaigns/Create'); ?>" class="project-title">
                        <div class="user-avatar sq bg-warning"><span>CC</span></div>
                        <div class="project-info">
                            <h6 class="title">Create Campaign</h6>
                ...
                <div class="project-details">
                    <p>Create a new Marketing Campaign to reach more users!</p>
                </div>
                <div class="project-progress">
                    <div class="project-progress-details">
                        <div class="project-progress-task"><em class="icon ni ni-check-round-cut"></em><span><?php echo $totalActiveUsers; ?> Active Users</span></div>
                        <div class="project-progress-percent"><?php echo $usersPercentage; ?></div>
                    </div>
                    <div class="progress progress-pill progress-md bg-light">
                        <div class="progress-bar" data-progress="<?php echo str_replace('%', '', $usersPercentage); ?>"></div>
                    </div>
                </div>
                <!-- <div class="project-meta">
                    <ul class="project-users g-1">
            ...
            <div class="project">
                <div class="project-head">
                    <a href="html/apps-kanban.html" class="project-title">
                        <div class="user-avatar sq bg-info"><span>CE</span></div>
                        <div class="project-info">
                            <h6 class="title">Create Expense</h6>
    ...
    <div class="card card-bordered h-100">
        <div class="card-inner">
            <div class="project">
                <div class="project-head">
                    <a href="<?php echo site_url('Management/Marketing/Analytics'); ?>" class="project-title">
                        <div class="user-avatar sq bg-purple"><span>PS</span></div>
                        <div class="project-info">
                            <h6 class="title">Create Page SEO</h6>
                            <!-- <span class="sub-text">Softnio</span> -->
                        </div>
                    </a>
                    <div class="dropdown">
                ...
                <div class="project-details">
                    <p>Create Page SEO Record for new webpage or link.</p>
                </div>
                <div class="project-progress">
                    <div class="project-progress-details">
                        <div class="project-progress-task"><em class="icon ni ni-check-round-cut"></em><span><?php echo $totalPageSEOTasks; ?> Tasks</span></div>
                        <div class="project-progress-percent">93.5%</div>
                    </div>
                    <div class="progress progress-pill progress-md bg-light">
                        <div class="progress-bar" data-progress="93.5"></div>
            ...
            <div class="project">
                <div class="project-head">
                    <a href="<?php echo site_url('Management/Assets/Distribute'); ?>" class="project-title">
                        <div class="user-avatar sq bg-warning"><span>CC</span></div>
                        <div class="project-info">
                            <h6 class="title">Create Email</h6>
                            <!-- <span class="sub-text">Runnergy</span> -->
                        </div>
                    </a>
                    <div class="dropdown">
            ...
            <div class="project">
                <div class="project-head">
                    <a href="html/apps-kanban.html" class="project-title">
                        <div class="user-avatar sq bg-info"><span>CE</span></div>
                        <div class="project-info">
                            <h6 class="title">Create Social Media Post</h6>
                            <!-- <span class="sub-text">Techyspec</span> -->
                        </div>
                    </a>
                    <div class="dropdown">
