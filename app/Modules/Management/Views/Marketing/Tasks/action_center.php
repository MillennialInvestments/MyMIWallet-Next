        ...
        <div class="card-inner">
            <div class="nk-wg-action">
                <div class="nk-wg-action-content">
                    ...
                    <p>Create and assign a new tasks to the MyMI Marketing Team.</p>
                </div>
                <a href="<?php echo site_url('/Management/Marketing/Tasks/Create'); ?>" class="btn btn-icon btn-trigger me-n2"><em class="icon ni ni-forward-ios"></em></a>
            </div>
        </div><!-- .card-inner -->
        <div class="card-inner">
            <div class="nk-wg-action">
