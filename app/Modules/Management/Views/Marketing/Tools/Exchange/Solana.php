                ...
                <div class="card-inner-group">
                    ...
                    <div class="card-inner">
                        <div class="d-flex pb-md-4">
                            ...
                            <h6>
                                <small class="fs-14px"><?php echo number_format($totalPendingAssets,0); ?> / <?php echo $totalApprovedAssets; ?></small>
                                <br>
                                <small class="fs-14px">Pending / Active <em class="icon ni ni-info"></em></small>
                            </h6>
                            <!-- <p class="mb-0">Total Assets</p> -->
                            </div>
                        </div>
                        <a class="btn btn-primary btn-block" href="<?= site_url('Exchange/Solana'); ?>"><i class="icon ni ni-eye"></i> View Assets</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card card-bordered h-100">
                <div class="card-inner-group">
                    ...
                    <div class="card-inner">
                        ...
                        <a href="<?php echo site_url('Management/Marketing/Promote/Solana'); ?>" class="btn btn-primary btn-block"><i class="icon ni ni-eye"></i> View Dashhboard</a>
                    </div>
                </div>
            </div>
        </div>
