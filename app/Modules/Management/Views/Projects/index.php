...
<div class="nk-block">
    <div class="row g-gs">
        ...
        <!-- <div class="col-md-12 col-xl-4">
            <div class="card card-bordered h-100">
                <div class="card-inner">
                    <?php //echo view('UserModule\Views\Projects\index\revenue_distribution', $subViewData); ?>
                </div>
            </div>
        </div> -->
        ...
        <!-- <div class="col-md-12 col-xl-8">
            <div class="card card-bordered h-100">
                <div class="card-inner">
                    <?php //echo view('UserModule\Views\Projects\index\commitment_overview', $subViewData); ?>
                </div>
            </div>
        </div> -->
