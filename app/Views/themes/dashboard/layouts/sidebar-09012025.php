...
$projectOperations                  = $siteSettings->projectOperations;
...
// log_message('info', 'dashboard/sidebar L29 - $userBudget: ' . (print_r($userBudget, true))); 
					...
					<div class="user-account-info between-center">
						<div class="user-account-main">
							...
							<div class="user-balance">
                                <?php 
                                        echo '$' . number_format((float) ($checkingSummary ?? 0), 2);
                                ?>
					...
					<div class="nk-profile-content" data-content="sidebarProfile">
						<div class="user-account-info between-center">
							<div class="user-account-main">
								...
								<div class="user-balance">
                                    <?php 
                                        echo '$' . number_format($checkingSummary ?? 0, 2);
                                    ?>
									<small class="currency currency-usd">USD</small>
								</div>
								<div class="user-balance-alt">
