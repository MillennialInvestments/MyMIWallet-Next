					...
					<div class="user-account-info between-center">
						<div class="user-account-main">
							...
							<div class="user-balance-alt">
                                ...
                                echo $MyMIGCoinSum . ' <span class="currency currency-usd">MyMI Gold</span> <a class="currency currency-usd dynamicModalLoader" data-formtype="Purchase" data-endpoint="purchasePaypal" href="#"><span class="nk-menu-text">Purchase</span></a>';
                                ?>
                            ...
                            <ul class="nk-menu-sub">
                                ...
                                <li class="nk-menu-item">
                                    <a href="<?php echo site_url('MyMI-Gold/Goals/Daily'); ?>" class="nk-menu-link" title="">
                                        <span class="nk-menu-text">Daily <small>(<?php echo number_format($userNextGoal['gold_reward'],0) ?? '0'; ?> MyMIGold Left)</small></span>
                                    </a>
                                </li>
                                <?php endif; ?>
                            ...
                            <ul class="nk-menu-sub px-3">
                                ...
                                <li class="nk-menu-item">
                                    <a href="<?php echo site_url('/Exchange/Solana/Assets'); ?>" class="nk-menu-link">
                                        <span class="nk-menu-icon"><em class="icon ni ni-layers"></em></span><span class="nk-menu-text">Assets <?= $siteSettings->createSolanaStatus; ?></span>
                                    </a>
                                </li>
                                <li class="nk-menu-item">
                                ...
                                <!-- <li class="nk-menu-item">
                                    <a href="<?php //echo site_url('/Exchange/Solana/Wallet/Verify-Ownership'); ?>" class="nk-menu-link">
                                        <span class="nk-menu-icon"><em class="icon ni ni-check-circle"></em></span><span class="nk-menu-text">Verify Wallet Ownership</span>
                                    </a>
                                </li> -->
                            </ul><!-- .nk-menu-sub -->
                        </li> 
                    ...
                    <ul class="nk-menu">
                        ...
                        <li class="nk-menu-item has-sub">
                            ...
                            <ul class="nk-menu-sub px-3">
                                ...
                                <li class="nk-menu-item divider my-1"></li>
                                <?php if($siteSettings->solanaUserAssets === 0) : ?>
                                <li class="nk-menu-item">
                                    <a href="<?php echo site_url('/Exchange/Solana/Assets'); ?>" class="nk-menu-link">
                                ...
                                <?php endif; ?>
                                <?php if($siteSettings->createSolanaStatus === 0) : ?>
                                <li class="nk-menu-item">
                                    <a href="<?php echo site_url('/Exchange/Solana/Create'); ?>" class="nk-menu-link">
                                        <span class="nk-menu-icon"><em class="icon ni ni-wallet-alt"></em></span><span class="nk-menu-text">Create</span>
                                    </a>
                                ...
                                <?php endif; ?>
                                <li class="nk-menu-item">
                                    <a href="<?php echo site_url('/Exchange/Solana/Import'); ?>" class="nk-menu-link">
                                        <span class="nk-menu-icon"><em class="icon ni ni-wallet-alt"></em></span><span class="nk-menu-text">Import</span>
                                    </a>
                                </li>
                                <?php if ($cuRole <= 2) : ?>
                                <li class="nk-menu-item">
                                ...
                                <?php endif; ?>
                                <?php if($siteSettings->swapSolanaStatus === 0) : ?>
                                <li class="nk-menu-item">
                                    <a href="<?php echo site_url('/Exchange/Solana/Swap'); ?>" class="nk-menu-link">
                                        <span class="nk-menu-icon"><em class="icon ni ni-swap"></em></span><span class="nk-menu-text">Swap</span>
                                    </a>
                                </li>
                                <?php endif; ?>
