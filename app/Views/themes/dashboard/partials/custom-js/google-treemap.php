<?php // app/Views/themes/dashboard/partials/custom-js/google-treemap.php ?>
<?php $nonce = $nonce ?? ['style' => '', 'script' => '']; ?>
<!-- Google Treemap Example -->
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js" <?= $nonce['script'] ?? '' ?>></script>
<script <?= $nonce['script'] ?? '' ?>>
