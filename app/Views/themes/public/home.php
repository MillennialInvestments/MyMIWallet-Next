...
$socialMedia           = $socialMedia ?? (object) ['promotional_yt_video' => 'https://www.youtube.com/embed/dQw4w9WgXcQ',
...
$socialPlatforms = [
    ...
    'Facebook Page' => [
        'button' => 'Like Our ',
        'url' => 'https://www.facebook.com/MyMIWalletNews',
    ...
    'Investors Talk FB Group' => [
        'button' => 'Join The ',
        'url' => 'https://www.facebook.com/InvestorsTalk',
    ...
    'LinkedIn' => [
        'button' => 'Connect On ',
        'url' => 'https://www.linkedin.com/MyMIWallet',
    ...
    'TikTok' => [
        'button' => 'Follow On ',
        'url' => 'https://www.tiktok.com/@MyMIWallet',
    ...
    'TradingView' => [
        'button' => 'Follow On ',
        'url' => 'https://www.tradingview.com/u/MyMIWallet/',
    ...
    <div class="container container-xl">
        ...
        <div class="row text-center g-4">
            <div class="col-6 col-md-3" data-aos="fade-up" data-aos-delay="100">
                <div class="stat-card">
                    <div class="display-4 fw-bold" data-counter="true" data-bs-target="<?= $totalActiveUsers ?? 0 ?>"><?= $totalActiveUsers ?? 0 ?></div>
                    <p>Active Users</p>
                </div>
            </div>
            <div class="col-6 col-md-3" data-aos="fade-up" data-aos-delay="200">
                <div class="stat-card">
                    <div class="display-4 fw-bold" data-counter="true" data-bs-target="<?= $totalWalletsCreated ?? 0 ?>"><?= $totalWalletsCreated ?? 0 ?></div>
                    <p>Wallets Created</p>
                </div>
            </div>
            <div class="col-6 col-md-3" data-aos="fade-up" data-aos-delay="300">
                <div class="stat-card">
                    <div class="display-4 fw-bold" data-counter="true" data-bs-target="<?= $totalTradesTracked ?? 0 ?>"><?= $totalTradesTracked ?? 0 ?></div>
                    <p>Trades Tracked</p>
                </div>
            </div>
            <div class="col-6 col-md-3" data-aos="fade-up" data-aos-delay="400">
                <div class="stat-card">
                    <div class="display-4 fw-bold" data-counter="true" data-bs-target="<?= $totalActivePartners ?? 0 ?>"><?= $totalActivePartners ?? 0 ?></div>
                    <p>Active Partners</p>
                </div>
            </div>
        </div>
