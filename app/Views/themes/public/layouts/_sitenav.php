...
$brandImage = base_url('assets/images/MyMI-Wallet-Logo-White.svg');
...
<nav class="intro-navbar navbar navbar-expand-lg intro-navbar">
    <div class="container container-xl">
        <a class="navbar-brand d-flex align-items-center" href="<?= $homeUrl ?>">
            <img
                class="logo-img logo-dark img-fluid"
                src="<?= esc($brandImage) ?>"
                srcset="<?= esc($brandImage) ?>"
                alt="<?= esc($brandAlt) ?>"
            >
        </a>
        ...
        <div class="collapse navbar-collapse intro-nav align-items-right" id="publicNavbarNav">
            <ul class="navbar-nav mt-1 ps-4 ps-lg-0 w-100">
                ...
                <li class="nav-item intro-nav-item dropdown">
                    <a class="nav-link intro-nav-link dropdown-toggle"
                       href="#"
                       id="resourcesDropdownPublic"
                       role="button"
                       data-bs-toggle="dropdown"
                       aria-expanded="false">
                        Resources
                    </a>
                    <ul class="dropdown-menu public-sitenav-dropdown"
                        aria-labelledby="resourcesDropdownPublic">
                ...
                <li class="nav-item intro-nav-item d-lg-inline-flex">
                    <a href="<?= $supportUrl ?>" target="_blank" rel="noopener noreferrer" class="nav-link intro-nav-link">Support</a>
                </li>
                <li class="nav-item intro-nav-item py-1 ps-lg-1 ms-lg-auto">
                    <?php if ($isLoggedIn): ?>
