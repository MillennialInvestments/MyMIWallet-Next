...
export declare class UserService {
    ...
    constructor(logger: Logger, userRepository: UserRepository, projectRepository: ProjectRepository, mailer: UserManagementMailer, urlService: UrlService, eventService: EventService, publicApiKeyService: PublicApiKeyService, roleService: RoleService, globalConfig: GlobalConfig);
