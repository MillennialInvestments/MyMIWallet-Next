import type { ChatHubUpdateAgentRequest, ChatHubCreateAgentRequest, ChatModelDto } from '@n8n/api-types';
...
export declare class ChatHubAgentService {
    ...
    createAgent(user: User, data: ChatHubCreateAgentRequest): Promise<ChatHubAgent>;
    updateAgent(id: string, user: User, updates: ChatHubUpdateAgentRequest): Promise<ChatHubAgent>;
