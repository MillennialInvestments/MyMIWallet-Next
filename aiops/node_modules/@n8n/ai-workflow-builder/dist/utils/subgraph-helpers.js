...
const state_reducers_1 = require("./state-reducers");
        ...
        if ((0, langgraph_1.isCommand)(result)) {
            if (isCommandUpdate(result.update)) {
                ...
                if (result.update.nodeConfigurations) {
                    (0, state_reducers_1.mergeNodeConfigurations)(nodeConfigurations, result.update.nodeConfigurations);
                }
            }
        }
