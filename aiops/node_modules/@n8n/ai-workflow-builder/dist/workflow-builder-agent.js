...
const legacy_agent_prompt_1 = require("./prompts/legacy-agent.prompt");
...
class WorkflowBuilderAgent {
    ...
    createMultiAgentGraph(featureFlags) {
    ...
    createLegacyWorkflow(featureFlags) {
        ...
        const mainAgentPrompt = (0, legacy_agent_prompt_1.createMainAgentPrompt)({
        ...
        const callModel = async (state) => {
            ...
            if (estimatedTokens > constants_1.MAX_INPUT_TOKENS) {
                throw new errors_1.WorkflowStateError(PROMPT_IS_TOO_LARGE_ERROR);
            }
    ...
    setupAgentAndConfigs(payload, userId, abortSignal, externalCallbacks) {
        ...
        const streamConfig = {
            ...
            recursionLimit: payload.featureFlags?.multiAgent
                ? constants_1.MAX_MULTI_AGENT_STREAM_ITERATIONS
                : constants_1.MAX_SINGLE_AGENT_STREAM_ITERATIONS,
            signal: abortSignal,
