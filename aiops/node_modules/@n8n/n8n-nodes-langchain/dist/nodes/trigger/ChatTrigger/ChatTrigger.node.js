...
class ChatTrigger extends import_n8n_workflow.Node {
  constructor() {
    ...
    this.description = {
      ...
      properties: [
        ...
        {
          displayName: 'Your n8n users will be able to use this agent in <a href="/home/chat/" target="_blank">Chat</a> once this workflow is published. Make sure to share this workflow with at least Project Chat User access to all users who should use it. Currently, only streaming response mode is supported.',
          name: "availableInChatNotice",
          type: "notice",
          displayOptions: {
            show: {
  ...
  async webhook(ctx) {
    ...
    const enableStreaming = availableInChat ? !options.responseMode || options.responseMode === "streaming" : options.responseMode === "streaming";
