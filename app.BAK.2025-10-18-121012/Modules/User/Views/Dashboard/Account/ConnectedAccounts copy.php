            ...
            <div class="card-inner card-inner-lg">
                ...
                <div class="nk-block">
                    <div class="nk-data data-list">
                        <div class="data-head">
                            <h6 class="overline-title">Food Delivery Apps</h6>
                        </div>
                        <div class="data-item" data-bs-toggle="modal" data-bs-target="#profile-edit">
                            <div class="data-col">
                                <span class="data-label">DoorDash</span>
                        ...
                        <div class="data-item" data-bs-toggle="modal" data-bs-target="#profile-edit">
                            <div class="data-col">
                                <span class="data-label">GrubHub</span>
                                <span class="data-value">-- Not Connected --</span>
                            </div>
                        ...
                        <div class="data-item" data-bs-toggle="modal" data-bs-target="#profile-edit">
                            <div class="data-col">
                                <span class="data-label">Instacart</span>
                                <span class="data-value">-- Not Connected --</span>
                            </div>
                            <div class="data-col data-col-end"><a class="btn btn-primary" href="#">Connect</a></div>
                        </div><!-- data-item -->
                        <div class="data-item">
                            <div class="data-col">
                                <span class="data-label">Postmates</span>
                                <span class="data-value">-- Not Connected --</span>
                            </div>
                            <div class="data-col data-col-end"><a class="btn btn-primary" href="#">Connect</a></div>
                        </div><!-- data-item -->
                        <div class="data-item">
                            <div class="data-col">
                                <span class="data-label">Rover</span>
                                <span class="data-value">-- Not Connected --</span>
                            </div>
                            <div class="data-col data-col-end"><a class="btn btn-primary" href="#">Connect</a></div>
                        </div><!-- data-item -->
                        <div class="data-item">
                            <div class="data-col">
                                <span class="data-label">Shipt</span>
                                <span class="data-value">-- Not Connected --</span>
                            </div>
                            <div class="data-col data-col-end"><a class="btn btn-primary" href="#">Connect</a></div>
                        </div><!-- data-item -->
                        <div class="data-item">
                            <div class="data-col">
                                <span class="data-label">TaskRabbit</span>
                                <span class="data-value">-- Not Connected --</span>
                            </div>
                            <div class="data-col data-col-end"><a class="btn btn-primary" href="#">Connect</a></div>
                        </div><!-- data-item -->
                        <div class="data-item">
                            <div class="data-col">
                                <span class="data-label">UberEats</span>
                                <span class="data-value">-- Not Connected --</span>
                            </div>
                            <div class="data-col data-col-end"><a class="btn btn-primary" href="#">Connect</a></div>
                        </div><!-- data-item -->
                    ...
                    <div class="nk-data data-list">
                        <div class="data-head">
                            <h6 class="overline-title">Ridesharing Apps</h6>
                        </div>
                        <div class="data-item">
                            <div class="data-col">
                                <span class="data-label">Uber</span>
                                <span class="data-value">-- Not Connected --</span>
                            </div>
                            <div class="data-col data-col-end"><a class="btn btn-primary" href="#">Connect</a></div>
                        </div><!-- data-item -->
                        <div class="data-item">
                            <div class="data-col">
                                <span class="data-label">Lyft</span>
                                <span class="data-value">-- Not Connected --</span>
                            </div>
                            <div class="data-col data-col-end"><a class="btn btn-primary" href="#">Connect</a></div>
                        </div><!-- data-item -->
                    ...
                    <div class="nk-data data-list">
                        <div class="data-head">
                            <h6 class="overline-title">Services Apps</h6>
                        </div>
                        <div class="data-item" data-bs-toggle="modal" data-bs-target="#profile-edit">
                            <div class="data-col">
                                <span class="data-label">Angi's</span>
                                <span class="data-value">-- Not Connected --</span>
                            </div>
                            <div class="data-col data-col-end"><a class="btn btn-primary" href="#">Connect</a></div>
                        </div><!-- data-item -->
                        <div class="data-item" data-bs-toggle="modal" data-bs-target="#profile-edit">
                            <div class="data-col">
                                <span class="data-label">Handy</span>
                                <span class="data-value">-- Not Connected --</span>
                            </div>
                            <div class="data-col data-col-end"><a class="btn btn-primary" href="#">Connect</a></div>
                        </div><!-- data-item -->
                        <div class="data-item" data-bs-toggle="modal" data-bs-target="#profile-edit">
                            <div class="data-col">
                                <span class="data-label">Houzz</span>
                                <span class="data-value">-- Not Connected --</span>
                            </div>
                            <div class="data-col data-col-end"><a class="btn btn-primary" href="#">Connect</a></div>
                        </div><!-- data-item -->
                        <div class="data-item" data-bs-toggle="modal" data-bs-target="#profile-edit">
                            <div class="data-col">
                                <span class="data-label">Porch</span>
                                <span class="data-value">-- Not Connected --</span>
                            </div>
                            <div class="data-col data-col-end"><a class="btn btn-primary" href="#">Connect</a></div>
                        </div><!-- data-item -->
                        <div class="data-item" data-bs-toggle="modal" data-bs-target="#profile-edit">
                            <div class="data-col">
                                <span class="data-label">Thumbtack</span>
                                <span class="data-value">-- Not Connected --</span>
                            </div>
                            <div class="data-col data-col-end"><a class="btn btn-primary" href="#">Connect</a></div>
                        </div><!-- data-item -->
