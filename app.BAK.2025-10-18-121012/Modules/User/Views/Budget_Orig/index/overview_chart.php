                ...
                <div class="col-12 col-sm-3 col-md-6 col-xxl-3">
                    <a href="<?php echo site_url('Budget/Income'); ?>">
                        <div class="nk-order-ovwg-data surplus">
                            ...
                            <div class="info row">
                                <span class="col-6 p-0">Last Month</span><span class="col-6 p-0 text-right"><strong><?php //echo '$' . number_format($lastMonthsExpense/20,2) ?? 0; ?></strong></span>
                                <span class="col-6 p-0">Next Month</span><span class="col-6 p-0 text-right"><strong><?php //echo '$' . number_format($nextMonthsExpense/20,2) ?? 0; ?></strong></span>
                            </div>
                        </div>
                    </a>
                </div>
