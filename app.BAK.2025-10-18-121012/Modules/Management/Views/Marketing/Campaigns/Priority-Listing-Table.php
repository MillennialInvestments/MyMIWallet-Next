    ...
    <div class="card-inner-group">
        <div class="card-inner card-inner-md">
            <div class="card-title-group">
                <div class="card-title">
                    <h6 class="title">Priority Marketing Campaigns</h6>
                </div>
        ...
        <div class="card-inner">
            <div class="nk-block">
                <div class="row">
                    <div class="col">
                        <table class="table table-striped table-bordered" id="marketingPriorityCampaignOverview">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php 
                                foreach($getActivePriorityCampaigns as $campaigns) {
                                    echo '
                                    <tr>
