...
// // Assuming $uri is passed from the controller

// // Safely get URI segments
// function getUriSegment($uri, $segmentNumber) {
//     return $uri->getTotalSegments() >= $segmentNumber ? $uri->getSegment($segmentNumber) : null;
// }
// $pageURIA = getUriSegment($uri, 1) ?? null;
// $pageURIB = getUriSegment($uri, 2) ?? null;
// $pageURIC = getUriSegment($uri, 3) ?? null;
// $pageURID = getUriSegment($uri, 4) ?? null;
// $pageURIE = getUriSegment($uri, 5) ?? null;

// Get Page Info
// $pageType = ''; // Define how you get this in CI4
// $pageName = ''; // Define how you get this in CI4
