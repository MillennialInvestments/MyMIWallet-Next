...
- Migration: _None_
- Model:
- Code references: app/Models/AlertsModel.php:726, app/Models/UserModel.php:76, app/Models/UserModel.php:133, docs/operations/05-database.md:26, docs/functional_inventory/docs_to_code_map.md:51, docs/functional_inventory/docs_to_code_map.md:90
