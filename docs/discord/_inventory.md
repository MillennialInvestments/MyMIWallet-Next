...
| server_setup_and_ci4_integration.md | — | `/API/Alerts/sendDiscordAlerts`, `/API/Alerts/sendDiscordAlertsBySymbol/{symbol}`, `/API/Management/sendAllDiscordAlerts` | bf_discord_channels, bf_discord_templates, bf_discord_subscriptions | DISCORD_DEFAULT_WEBHOOK, DISCORD_ALERTS_WEBHOOK, DISCORD_MARKETING_WEBHOOK, DISCORD_EARNINGS_WEBHOOK, DISCORD_OPS_WEBHOOK, DISCORD_SUPPORT_WEBHOOK, DISCORD_ALERTS_TIER{1..3}_WEBHOOK, DISCORD_BOT_TOKEN, DISCORD_GUILD_ID, DISCORD_ALERTS_DRY_RUN, DISCORD_USE_BOT_API_FALLBACK | End-to-end checklist for creating channels, mapping webhooks, wiring alerts/marketing/earnings routes, and validating deployments. |
