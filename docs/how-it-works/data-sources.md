...
description: An overview of the primary financial and crypto data sources used in platform reporting and automation.
---

# Data Sources

An overview of the primary financial and crypto data sources used in platform reporting and automation.

## What This Page Covers

- Core concepts behind **Data Sources** inside the MyMI Wallet ecosystem.
...
- Data Sources workflows are designed to be understandable for beginners and actionable for experienced users.
...
Create your MyMI Wallet account and activate **Data Sources** to move from planning to execution with a repeatable workflow.
