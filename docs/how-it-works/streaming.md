...
slug: streaming
category: community
description: How live streaming can be used for education, market commentary, and consistent audience engagement.
---

# Streaming

How live streaming can be used for education, market commentary, and consistent audience engagement.

## What This Page Covers

- Core concepts behind **Streaming** inside the MyMI Wallet ecosystem.
...
- Streaming workflows are designed to be understandable for beginners and actionable for experienced users.
...
Create your MyMI Wallet account and activate **Streaming** to move from planning to execution with a repeatable workflow.
