...
slug: trade-alerts
category: alerts
description: How to configure and use real-time market alerts for entries, exits, risk levels, and event-driven conditions.
---

# Trade Alerts

How to configure and use real-time market alerts for entries, exits, risk levels, and event-driven conditions.

## What This Page Covers

- Core concepts behind **Trade Alerts** inside the MyMI Wallet ecosystem.
...
- Trade Alerts workflows are designed to be understandable for beginners and actionable for experienced users.
...
Create your MyMI Wallet account and activate **Trade Alerts** to move from planning to execution with a repeatable workflow.
