...
description: How external APIs integrate with MyMI Wallet to power analytics, alerts, and automated workflows.
---

# API Integrations

How external APIs integrate with MyMI Wallet to power analytics, alerts, and automated workflows.

## What This Page Covers

- Core concepts behind **API Integrations** inside the MyMI Wallet ecosystem.
...
- API Integrations workflows are designed to be understandable for beginners and actionable for experienced users.
...
Create your MyMI Wallet account and activate **API Integrations** to move from planning to execution with a repeatable workflow.
