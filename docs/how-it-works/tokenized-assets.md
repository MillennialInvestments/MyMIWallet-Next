...
category: crypto
description: How tokenization broadens access to assets and what users should understand operationally and strategically.
---

# Tokenized Assets

How tokenization broadens access to assets and what users should understand operationally and strategically.

## What This Page Covers

- Core concepts behind **Tokenized Assets** inside the MyMI Wallet ecosystem.
...
- Tokenized Assets workflows are designed to be understandable for beginners and actionable for experienced users.
...
Create your MyMI Wallet account and activate **Tokenized Assets** to move from planning to execution with a repeatable workflow.
