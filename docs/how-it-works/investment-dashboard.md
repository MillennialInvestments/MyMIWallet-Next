...
category: investing
description: How to use the investment dashboard to monitor positions, changes, watchlists, and signal activity in one place.
---

# Investment Dashboard

How to use the investment dashboard to monitor positions, changes, watchlists, and signal activity in one place.

## What This Page Covers

- Core concepts behind **Investment Dashboard** inside the MyMI Wallet ecosystem.
...
- Investment Dashboard workflows are designed to be understandable for beginners and actionable for experienced users.
...
Create your MyMI Wallet account and activate **Investment Dashboard** to move from planning to execution with a repeatable workflow.
