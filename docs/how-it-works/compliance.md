...
slug: compliance
category: security
description: How compliance practices support trustworthy fintech operations, process transparency, and risk controls.
---

# Compliance

How compliance practices support trustworthy fintech operations, process transparency, and risk controls.

## What This Page Covers

- Core concepts behind **Compliance** inside the MyMI Wallet ecosystem.
...
- Compliance workflows are designed to be understandable for beginners and actionable for experienced users.
...
Create your MyMI Wallet account and activate **Compliance** to move from planning to execution with a repeatable workflow.
