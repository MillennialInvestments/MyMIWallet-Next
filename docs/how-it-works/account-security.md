...
category: security
description: How to secure user credentials, sessions, account recovery, and ongoing account hygiene across web and API surfaces.
---

# Account Security

How to secure user credentials, sessions, account recovery, and ongoing account hygiene across web and API surfaces.

## What This Page Covers

- Core concepts behind **Account Security** inside the MyMI Wallet ecosystem.
...
- Account Security workflows are designed to be understandable for beginners and actionable for experienced users.
...
Create your MyMI Wallet account and activate **Account Security** to move from planning to execution with a repeatable workflow.
