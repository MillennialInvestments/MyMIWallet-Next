...
category: investing
description: How to track holdings, measure performance, rebalance allocations, and document portfolio strategy over time.
---

# Investment Portfolio Management

How to track holdings, measure performance, rebalance allocations, and document portfolio strategy over time.

## What This Page Covers

- Core concepts behind **Investment Portfolio Management** inside the MyMI Wallet ecosystem.
...
- Investment Portfolio Management workflows are designed to be understandable for beginners and actionable for experienced users.
...
Create your MyMI Wallet account and activate **Investment Portfolio Management** to move from planning to execution with a repeatable workflow.
