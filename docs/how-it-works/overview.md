...
description: A high-level walkthrough of how MyMI Wallet connects budgeting, forecasting, investing, alerts, crypto assets, and automation into one operating system for financial decision-making.
---

# Overview

A high-level walkthrough of how MyMI Wallet connects budgeting, forecasting, investing, alerts, crypto assets, and automation into one operating system for financial decision-making.

## What This Page Covers

- Core concepts behind **Overview** inside the MyMI Wallet ecosystem.
...
- Overview workflows are designed to be understandable for beginners and actionable for experienced users.
...
Create your MyMI Wallet account and activate **Overview** to move from planning to execution with a repeatable workflow.
