...
slug: security
category: security
description: Platform-wide security controls spanning authentication, authorization, data protection, and monitoring.
---

# Security

Platform-wide security controls spanning authentication, authorization, data protection, and monitoring.

## What This Page Covers

- Core concepts behind **Security** inside the MyMI Wallet ecosystem.
...
- Security workflows are designed to be understandable for beginners and actionable for experienced users.
...
Create your MyMI Wallet account and activate **Security** to move from planning to execution with a repeatable workflow.
